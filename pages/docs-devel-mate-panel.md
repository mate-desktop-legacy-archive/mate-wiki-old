...
This page shows all changes introduces with GSettings/DBUS migration in MATE
panel since 1.5.0 release.

All matecorba, matecomponent and mateconf (they were orbit, bonobo and gconf
in GNOME) stuff is removed in mate-panel 1.5.0+ and replaced with
GSettings/DBUS.

## Debug DBUS applets

With the following command you can use **gdb** to debug DBUS applets, and
activate them with **mate-panel-test-applets** tool.

    
    
     gdb /path/to/applet/binary

## Python applets

The old [mateapplet](https://github.com/mate-desktop/python-mate-desktop/tree/master/mateapplet) module found in [python-mate-
desktop](https://github.com/mate-desktop/python-mate-desktop) package will be
removed.

You need to migrate your python MATE applets to introspection. This is simple
and you can use the following example applet to learn how this will works.

### An example applet with introspection
...
You need to create a GSettings object with path and schema:

    
    
    from gi.repository import Gio
    settings = Gio.Settings.new_with_path("org.mate.panel.applet.test-applet", settings_path)
    sample_string = settings.get_string("sample-key")

### Convert old applets

You can use the following script as starting point to migrate old applets
using mateapplet and pygtk.
